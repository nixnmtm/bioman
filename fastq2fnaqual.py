...
parser.add_argument("-q", "--qual", default="P33", help="Quality encoding: default is 'P33' meaning Phred33 (works for Sanger and Illumina 1.8+, 'illumina' stands for Illumina 1.5+ encoding ")
