...
### renvoit le nombre de sequences total et le nombre de sequences annotees
...
# pour rajouter separateur apres un split
def add_sep_hit(x):
	return "<Hit>"+x
...
print("Nombre de sequences initiales: "+str(seq_count))
print("Nombre de sequences annotees: "+str(seq_annot_count))
